...
namespace RECFAST_physical_constants 
{
	...
	const double RF_age		 = 4.512E+17;    	    // Age of the Universe [s]
    const double RF_A        = 3.688E-11;            // Universe Acceleration [m s-2]
    const double RF_V        = 3.164E+08;           // Initial Tangent Velocity
