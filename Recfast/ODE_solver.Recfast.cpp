                           ...
                           vector<double> &c)
{
    ...
    //------------------------------------------------------
    unsigned int n=static_cast<int>(b.size());
...
{
    int neq=static_cast<int>(b.size());
    int nJac=static_cast<int>(A.size());
    if(nJac!=neq*neq)
    { 
...
void ODE_Solver_set_up_solution_and_memory(double z, ODE_solver_Solution &Sz, 
                                           void (*fcn_ptr)(int *neq, double *z, double *y, double *f))
{
    int neq=static_cast<int>(Sz.y.size());
                               ...
                               const ODE_solver_Solution &Snm5)
{
    ...
    int neq=static_cast<int>(Snp1_new.y.size());
                                 ...
                                 const ODE_solver_Solution &Snm5)
{
    ...
    int neq=static_cast<int>(Sn.y.size());
                                                          ...
                                                          int messflag=1)
{
    ...
    //--------------------------------------------------------
    int neq= static_cast<int>(S.y.size());
                                    ...
                                    const ODE_solver_Solution &Snm5)
{
    ...
    int neq= static_cast<int>(Sn.y.size()), converged=0;
